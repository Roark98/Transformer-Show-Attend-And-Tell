...
def caption_image_beam_search(encoder, decoder, image_path, word_map, beam_size=3):
    ...
    encoder_out = encoder(image)['last_hidden_state']  # (1, enc_image_size, enc_image_size, encoder_dim)
...
if __name__ == '__main__':
    ...
    for z in range(1):
        ...
        final = time.time()
        if z!=0:
            resultados.append(final-inicio)
    #print(resultados)
    #print("TIEMPO DE INFERENCIA: "+str(sum(resultados)/len(resultados)))
    # Visualize caption and attention of best sequence
    visualize_att(args.img, seq, rev_word_map, args.smooth)
